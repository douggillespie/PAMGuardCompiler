...
public abstract class JreForm extends JPanel
{
   ...
   protected final JComboBox _archRequirementCombo = new JComboBox();
   ...
   public JPanel createPanel()
   {
      ...
      _jdkPreferenceCombo.setName("archRequirementCombo");
      jpanel1.add(_archRequirementCombo,cc.xywh(8,6,3,1));
